   ...
   return (
      <div className='row d-flex main-content'>
         <div className="main-left col-md-5">
            ...
            <p className='main-para'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Itaque nisi ex consectetur possimus dolor debitis est. Reiciendis eaque unde hic fuga porro tempora? Quam, necessitatibus?</p>
